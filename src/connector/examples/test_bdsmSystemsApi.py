...
class TestSystem:
    def test_getSystem_Exbeur(self):
        system = System()
        json = system.getSystem("Exbeur")

        assert json['name'] == "Exbeur"

        # ids
        assert json['id'] == 13593
        assert json['id64'] == 1006909786467

        # coordinates
        # assert json['coords'] == True
        assert json['coords']['x'] == -35.15625
        assert json['coords']['y'] == 27.84375
        assert json['coords']['z'] == -33.65625

        # permit
        assert json['requirePermit'] == True
        assert json['permitName'] == "Exbeur"

        # information
        # assert json['information']['allegiance'] == "Federation"
        # assert json['information'] == 'government'
        # assert json['information'] == 'faction'
        # assert json['information'] == 'factionState'
        # assert json['information'] == 'population'
        # assert json['information'] == 'security'
        # assert json['information'] == 'economy'
        # assert json['information'] == 'secondEconomy'
        # assert json['information'] == 'reserve'

        # primaryStar
        # self.assertTrue(json['primaryStar'])
        # self.assertEqual("G (White-Yellow) Star", json['primaryStar']['type'])
        assert json['primaryStar']['name'] == "Exbeur"

        # assert json['primaryStar']['isScoopable'] == 'primaryStar'

    def test_getIds_Sol(self):
        json = System.getIds("Sol")
        # ids
        assert json['id'] == 27
        assert json['id64'] == 10477373803
    ...
    def test_getCoordinates_Sol(self):
        ...
        # coordinates
        assert json['coords'] == True
        assert json['coords']['x'] == 0
        assert json['coords']['y'] == 0
        assert json['coords']['z'] == 0
    ...
    def test_getCoordinates_Beagle(self):
        ...
        # coordinates
        assert json['coords'] == True
        assert json['coords']['x'] == -1111.5625
        assert json['coords']['y'] == -134.21875
        assert json['coords']['z'] == 65269.75
...
class SystemsTest(unittest.TestCase):
    ...
    def test_getSystems_list(self):
        system = System()
        json = system.getSystems("Sol", "Beagle Point")
